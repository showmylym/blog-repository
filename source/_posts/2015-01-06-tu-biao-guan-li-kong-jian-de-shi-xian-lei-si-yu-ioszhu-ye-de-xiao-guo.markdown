...
####*优酷视频iPad客户端*管理离线视频
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-1.PNG" title="图片2-1" alt="图片2-1" width="100%"/>    
####*微信*讨论组增删人员
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-2.PNG" title="图片2-2" alt="图片2-2" width="100%"/>    
####*有信*收藏栏
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-3.PNG" title="图片2-3" alt="图片2-3" width="100%"/>    
####*有信*照片墙
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-4.PNG" title="图片2-4" alt="图片2-4" width="100%"/>    
###大致工作流程为：    
...
####下图为正常状态下各个部分的有效区域：    
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-5.png" title="图片2-5" alt="图片2-5" width="100%"/>    
####下图为编辑状态下各个部分的有效区域：    
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-6.png" title="图片2-6" alt="图片2-6" width="100%"/>    
###大致使用流程为：    
####1、初始化：
...
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-7.jpg" title="图片2-7" alt="图片2-7" width="100%"/>    
...
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-8.png" title="图片2-8" alt="图片2-8" width="100%"/>    
####２、实现数据源方法
...
######注释的样子
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-9.png" title="图片2-9" alt="图片2-9" width="100%"/>    
######快速查看方法说明的样子
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-10.png" title="图片2-10" alt="图片2-10" width="100%"/>    
#####2、利用XCode的pragma分块特性提高定位效率  
　　<img src="http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-11.png" title="图片2-11" alt="图片2-11" width="100%"/>    
...
###后记：
　　距离上一篇博客发布已一个月有余，其实积攒了很多材料，但真的想把这一篇写好，写到自己满意的程度再发出来。
　　